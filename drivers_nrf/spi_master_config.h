...
/*  SPI0 */
#define SPI_PSELSCK0              2   /*!< GPIO pin number for SPI clock (note that setting this to 31 will only work for loopback purposes as it not connected to a pin) */
...
#define SPI_PSELSS0               1   /*!< GPIO pin number for Slave Select           */
