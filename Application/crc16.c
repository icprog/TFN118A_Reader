...
{		
	...
	for( i = 0; i < len; i++)     
	{     
			wTableNo = ((wResult & 0xff) ^ (src[i] & 0xff));     
...
// 	}
// 	return (((chCRCHi& 0x00ff) << 8) | chCRCLo);
// }
/**
*/
// #define CRCPOLY	0x8005
// uint16_t crc16_1(uint8_t * pin,uint16_t len)
// {
